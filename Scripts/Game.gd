...
@onready var parking_lot_2x2_scene: PackedScene = preload("res://Scenes/Gameboard Items/ParkingLot2x2.tscn")

# Called when the node enters the scene tree for the first time.
func _ready() -> void:
	
	##TEST: for the orientations
	var gameitem_1 = parking_lot_2x2_scene.instantiate()
	...
	##ROTATE 90
	var gameitem_2 = parking_lot_2x2_scene.instantiate()
	...
	##ROTATE 180
	var gameitem_3 = parking_lot_2x2_scene.instantiate()
	...
	##ROTATE 270
	var gameitem_4 = parking_lot_2x2_scene.instantiate()
	...
	## Flip V
	var gameitem_5 = parking_lot_2x2_scene.instantiate()
	...
	## FLip H
	var gameitem_6 = parking_lot_2x2_scene.instantiate()
	...
	## Flip V , rot 90
	var gameitem_7 = parking_lot_2x2_scene.instantiate()
	...
	## Flip H, rot 90
	var gameitem_8 = parking_lot_2x2_scene.instantiate()
